...
fetchEmails(savedDate);
  ...
  return (
    ...
    >
      ...
      {/* Main Content */}
      <div className="app-main-pad" style={{ padding: '32px', maxWidth: '1400px', margin: '0 auto' }}>
        {/* Stats Cards */}
        <div
          className="app-stat-strip"
          style={{
            display: 'grid',
    ...
    fetchEmails();
            ...
            <div className="app-flex-spacer" style={{ flex: 1 }} />
                  ...
                  <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
                    <button
                      ...
                      style={{
                        ...
                        boxShadow: loadingReply && selectedThreadId === email.threadId
                          ? 'none'
                          : '0 8px 22px rgba(34, 197, 94, 0.38)',
                      }}
                      onMouseEnter={(e) => {
                        if (!(loadingReply && selectedThreadId === email.threadId)) {
                          e.currentTarget.style.transform = 'translateY(-2px)';
                          e.currentTarget.style.boxShadow = '0 12px 28px rgba(34, 197, 94, 0.48)';
                        }
                      }}
                      onMouseLeave={(e) => {
                        e.currentTarget.style.transform = 'translateY(0)';
                        if (!(loadingReply && selectedThreadId === email.threadId)) {
                          e.currentTarget.style.boxShadow = '0 8px 22px rgba(34, 197, 94, 0.38)';
                        }
                      }}
                    >
                      {loadingReply && selectedThreadId === email.threadId ? '⏳ Generating...' : '✨ Generate Reply'}
                    </button>
                    <button
                      onClick={(e) => {
                        e.stopPropagation();
          ...
          <div className="homeReplyModal">
            <div className="homeReplyModalHeader">
              <div className="homeReplyModalTitleRow">
                <span className="homeReplyModalTitleIcon" aria-hidden>
                  ✨
                </span>
                <div>
                  <h3 className="homeReplyModalTitle">AI Generated Reply</h3>
                  <p className="homeReplyModalSubtitle">
                    Review and edit your reply, then save it as a Gmail draft.
                  </p>
                </div>
              </div>
              <button
